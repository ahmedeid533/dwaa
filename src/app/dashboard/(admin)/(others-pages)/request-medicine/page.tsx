...
// Updated the debounce utility to use generic types, resolving the 'any' type errors.
function debounce<F extends (...args: Parameters<F>) => ReturnType<F>>(
    func: F, 
    delay: number
): (...args: Parameters<F>) => void {
    let timeoutId: ReturnType<typeof setTimeout>;
    // [FIXED] Replaced 'this: any' with 'this: unknown' to satisfy the linter rule.
