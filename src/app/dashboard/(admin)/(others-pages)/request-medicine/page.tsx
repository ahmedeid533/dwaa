...
export default function RequestMedicinePage() {
  ...
  if (authLoading) return <div className="p-8 text-center">Loading user data...</div>;
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full p-3 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition"
            />
